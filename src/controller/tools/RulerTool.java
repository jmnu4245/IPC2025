...
public class RulerTool implements MapDrawingTool {
    ...
    public void activate() {
        if (rulerImageView == null) {
            Image rulerImage = new Image(getClass().getResourceAsStream("/resources/regla.png"));
    ...
    public void deactivate() {
        ...
        System.out.println("RulerTool desactivada.");
    }

    @Override
    public void onMouseClick(MouseEvent event, Point2D mapCoords) {
        // No acción necesaria para click simple en la regla
    }
        ...
        if (rulerImageView != null && rulerImageView.isVisible()) {
            ...
            if (rulerImageView.contains(localCoords)) {
                ...
                if (event.getButton() == MouseButton.SECONDARY) {
                    System.out.println("aqui1");// Botón derecho
    ...
    // Calcula el centro actual de la regla en coordenadas del mapa
